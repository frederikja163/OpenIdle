...
| TypeScript 7 (`tsgo`) | 7.0.2, stable since 2026-07-08 | Native Go port of the compiler; 8–12× faster full builds | Same team, brand new | Apache-2.0 | **Blocked**: no stable programmatic API, so `typescript-eslint` and the Svelte template checker cannot run on it |
